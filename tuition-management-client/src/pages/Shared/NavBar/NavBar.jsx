...
const NavBar = () => {
    ...
    return (
        <div className="navbar bg-base-100/90 backdrop-blur-md sticky top-0 z-50 shadow-sm px-4 lg:px-8">
            ...
            <div className="navbar-end gap-3">
                ...
                {user ? (
                    <>
                        <Link to="/dashboard" className="btn btn-outline btn-primary hidden sm:flex">Dashboard</Link>
                        <div className="dropdown dropdown-end">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow">
                                <li><span className="justify-between font-bold">{user?.displayName || "User"}</span></li>
